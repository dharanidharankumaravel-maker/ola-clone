                ...
                children: [
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Icon(Icons.camera_alt_outlined, size: 14, color: AppColors.white),
                        ),
                      ),
                    ],
                  ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Icons.account_balance_wallet_outlined, size: 14, color: AppColors.primaryGreen),
                        ...
                        const SizedBox(width: 4),
                        Text('Ola Money', style: AppTextStyles.caption.copyWith(color: AppColors.primaryGreen)),
                      ],
                    ),
                  ),
                ],
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _buildMenuItem(Icons.account_balance_wallet_outlined, 'Ola Wallet', () => context.push('/wallet')),
                  _buildMenuItem(Icons.inventory_2_outlined, 'Ola Parcel', () => context.push('/parcel')),
